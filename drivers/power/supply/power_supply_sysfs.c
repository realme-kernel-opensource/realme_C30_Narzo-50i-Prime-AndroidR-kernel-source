...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(ic_reg),
	POWER_SUPPLY_ATTR(fastcharger),
	POWER_SUPPLY_ATTR(enable_charge),
	POWER_SUPPLY_ATTR(chg_iterm),
	POWER_SUPPLY_ATTR(timer_enable),
	POWER_SUPPLY_ATTR(chg_vindpm),
	POWER_SUPPLY_ATTR(batfet_dis),
	...
	POWER_SUPPLY_ATTR(is_fchg_support),
	POWER_SUPPLY_ATTR(is_hvdcp),
	POWER_SUPPLY_ATTR(iterm_en),
	POWER_SUPPLY_ATTR(term_status),
