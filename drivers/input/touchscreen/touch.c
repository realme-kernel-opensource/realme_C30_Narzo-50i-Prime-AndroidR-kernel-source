...
int tp_register_devinfo(int version)
{
	...
	if (!(strncmp(lcd_str,"lcd_icnl9911c_hkc_mipi_hd",strlen("lcd_icnl9911c_hkc_mipi_hd")))) {
		snprintf(dev_version, MAX_DEVICE_VERSION_LENGTH, "HKCICNL9911C%X", version);
		snprintf(dev_vendor, MAX_DEVICE_MANU_LENGTH, "HKC");
	} else if(!(strncmp(lcd_str,"lcd_ili9882q_txd_mipi_hd",strlen("lcd_ili9882q_txd_mipi_hd")))){
		snprintf(dev_version, MAX_DEVICE_VERSION_LENGTH, "TXDILI9882Q%X", version);
		snprintf(dev_vendor, MAX_DEVICE_MANU_LENGTH, "TXD");
	} else if(!(strncmp(lcd_str,"lcd_icnl9911c_auo_mipi_hd",strlen("lcd_icnl9911c_auo_mipi_hd")))){
		snprintf(dev_version, MAX_DEVICE_VERSION_LENGTH, "AUOICNL9911C%X", version);
		snprintf(dev_vendor, MAX_DEVICE_MANU_LENGTH, "DJI");
	} else {
