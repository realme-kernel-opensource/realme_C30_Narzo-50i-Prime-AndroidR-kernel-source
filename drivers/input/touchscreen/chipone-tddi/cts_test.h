...
int set_fw_work_mode(struct cts_device *cts_dev, u8 mode);
	...
	int cts_test_gesture_rawdata(struct cts_device *cts_dev, struct cts_test_param *param);
	int cts_test_gesture_noise(struct cts_device *cts_dev, struct cts_test_param *param);
